...
public extension TransitStop {
    static let presetStops: [TransitStop] = [
        TransitStop(id: "9021014001238000", name: "Östermalmstorg", platform: "1"),
        TransitStop(id: "9021014001239000", name: "Skärholmen", platform: "1"),
        ...
        TransitStop(id: "9021014001008000", name: "Liljeholmen", platform: "1"),
        TransitStop(id: "9021014001009000", name: "Hornstull", platform: "1"),
        TransitStop(id: "9021014001010000", name: "Zinkensdamm", platform: "1"),
        TransitStop(id: "9021014001011000", name: "Medborgarplatsen", platform: "1"),
        TransitStop(id: "9021014001012000", name: "Hötorget", platform: "1"),
        TransitStop(id: "9021014001013000", name: "Rådmansgatan", platform: "1"),
